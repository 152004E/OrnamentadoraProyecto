  ...
  return (
    <footer className="w-full border-t rounded-2xl bg-blue-200/60 mt-10">
      <div className="p-6 flex flex-col justify-center items-center">
        ...
        {/* Links */}
        <div className="flex justify-baseline items-center gap-3 flex-wrap text-sm font-medium text-gray-600 mb-3">
          <FooterLInks to="/proyectos" linkText="Proyectos" />
          <FooterLInks to="/#nav" linkText="inicio" />
          <FooterLInks to="/register" linkText="Registrarse" />
          <FooterLInks to="/login" linkText="Iniciar Sesion" />
          <FooterLInks to="/nosotros" linkText="Nosotros" />
          <FooterLInks to="/contacto" linkText="Cotizar Proyecto" />
          <FooterLInks to="/AdminDashboardHome" linkText="Mi perfil" />
        </div>
        <div className="w-90 flex flex-col justify-around items-center p-6 bg-white gap-2 flex-wrap text-sm rounded-2xl font-medium text-gray-600">
      ...
      <div className="bg-blue-800 font-bold w-full h-full p-6 flex justify-center items-center">
        {/* Copyright */}
        <div className="text-sm text-gray-400 ">
          © {new Date().getFullYear()} WL ORNAMENTACIÓN & ALUMINIO S . A. Todos
